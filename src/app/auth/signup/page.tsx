...
export default function SignUpPage() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      toast({ variant: "destructive", title: "Sign up failed", description: "Please try again." });
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground font-body text-sm">
            Start designing your dream garden for free
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-garden-earth-light shadow-sm p-8">
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-white px-2 text-muted-foreground font-body">Or sign up with email</span>
            </div>
          </div>
          ...
          <p className="text-center text-sm text-muted-foreground font-body mt-6">
            ...
            <Link href="/auth/signin" className="text-garden-green hover:underline font-medium">
              Sign in
            </Link>
          </p>
        </div>
